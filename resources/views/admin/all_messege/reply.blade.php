...
@section('content')
    <div class=" register view-doner" style="padding-top: 7%;margin-left: 17%;">
        <div class="row container">
            ...
            <h4><i class="fa fa-angle-right"></i>Reply user Massage</h4>
            <hr>
            <div class="col-md-9 msg-table">
                ...
                <form id="replyForm" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly id="to_email" name="email"
                               value="{{$replymssg->email}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">From</label>
                        <input type="text" class="form-control" name="From" id="from_email"
                               placeholder="enter your email" value="developer@mdrupomehsan.com">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">subject</label>
                        <input type="text" class="form-control" name="subject" id="subject" placeholder="seubject"
                               value="Reply Message">
                    </div>
                    <div class="form-group">
