    ...
    <form id="pageForm"  enctype="multipart/form-data">
        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="pagename" placeholder="Page name" value="" />
            </div>
           <div class="form-group">
              <label for="exampleFormControlTextarea1">Descripsion</label>
              <textarea class="form-control" id="desc" name="pagedesc" rows="3"></textarea>
            </div>
