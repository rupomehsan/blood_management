            ...
            <div class="col-md-4 ">
                <div class="home-right right-one" style="padding-top: 150px;">
                    <div class="right-one">
                        ...
                        <div class="row">
                            <div class="col-md-6 rg-bttn " style="width: 30%">
                                <div class="button btn-one"><a href="{{route('website.alldoner')}}">All Doner </a></div>
                            </div>
                            <div class="col-md-6 rg-bttn " style="width: 40%">
                                <div class="button"><a href="{{route('website.registration')}}"> Register </a></div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 about-left" style="margin-top: 250px;">
                        <div class="tab" role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#abSection1" aria-controls="home"
                                                                          role="tab" data-toggle="tab">1</a></li>
                                <li role="presentation"><a href="#abSection2" aria-controls="profile" role="tab"
                                                           data-toggle="tab"> Education</a></li>
                                <li role="presentation"><a href="#abSection3" aria-controls="messages" role="tab"
                                                           data-toggle="tab"> Hobbies</a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content tabs">
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="abSection1">
                                    <div class="ih-item square effect9 bottom_to_top">
                                        <a>
                                            <div class="img"><img src="{{asset('client')}}/images/profile.jpg"
                                    ...
                                    <div class="center">
                                        <div id="social-test">
                                            <ul class="social">
                                                <li><a href="https://www.facebook.com/rupom.ehsan.5/" title=""><i
                                                            class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                                <li><a href="https://twitter.com/EhsanRupom" title=""><i
                                                            class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                                <li>
                                                    <a href="https://www.youtube.com/channel/UChAz_f_ngfpsBTSC2OgrRug?view_as=subscriber"
                                                       title=""><i class="fa fa-youtube" aria-hidden="true"></i></a>
                                                </li>
                                                <li><a href="https://github.com/rupomehsan" title=""><i
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 cv-part">
                                            ...
                                            <div class="downArrow bounce">
                                                <img width="40" height="40" alt=""
                                                     src="{{asset('client')}}/images/download-arrow.png"/>
                                            </div>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="abSection2">
                                    ...
                                    <p><span>web development course-->></span>creative shaper and agamisoft.lmt(dynamic)
                                    </p>
                                </div>
                                <div role="tabpanel" class="tab-pane fade" id="abSection3">
                                    ...
                                    <p><span>---->></span>Playing individual sports (criket,football,badminton, etc.)
                                    </p>
                ...
                <div class="row">
                    <div class="col-md-12 about-right" style="margin-top: 250px;">
                        <div class="tab" role="tabpanel">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#abrSection1" aria-controls="home"
                                                                          role="tab" data-toggle="tab">1</a></li>
                                <li role="presentation"><a href="#abrSection2" aria-controls="profile" role="tab"
                                                           data-toggle="tab"> profession</a></li>
                                <li role="presentation"><a href="#abrSection3" aria-controls="messages" role="tab"
                            ...
                            <div class="tab-content tabs">
                                <div role="tabpanel" class="tab-pane fade in active" id="abrSection1">
                                    ...
                                    <p>
                                        ...
                                        EXISITING WEBSITES OR WEB APPLICATION.BUILD SOCIAL PROFILES AND GAIN REVENUE AND
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="abrSection2">
                                    <h4>Profession </h4>
                                    <p>I am a Fullstack web developer at <a href="https://www.agamisoft.com/"><span>Agamisoft.LMT</span></a>
                                    </p>
                                    <p>formal frontend developer at <a href="https://mazetechbd.com/"><span>Mazetech bd.com</span></a>
                                    </p>
                                    <p> AS A WEB fullstack web DEVELOPER WORKING WITH LOCAL AND INTERNATIONAL CLIENTS
                                        like FREELANCER,FIVER,AND UPWORK marketplace SINCE 2018.</p>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="abrSection3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="serviceBox">
                                                <div class="service-icon"><i class="fa fa-database"
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="serviceBox">
                                                <div class="service-icon"><i class="fa fa-tablet"
                                                                             aria-hidden="true"></i></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="serviceBox">
                                                <div class="service-icon"><i class="fa fa-shopping-cart"
                                                                             aria-hidden="true"></i></div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="serviceBox">
                                                <div class="service-icon"><i class="fa fa-mobile"
                                                                             aria-hidden="true"></i></div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="serviceBox">
                                                <div class="service-icon"><i class="fa fa-wordpress"
                                                                             aria-hidden="true"></i></div>
                ...
                <div class="col-md-12">
                    <div class="tab tab-wrapper" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs skill-nav" role="tablist">
                            ...
                            <li role="presentation"><a href="#Section5" aria-controls="messages" role="tab"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12  main-row">
                                                <div class="pricing-box clrbg-before clrbg-after transition">
                                                    ...
                                                    <div
                                                        class="pricing-hover clrbg-before clrbg-after transition"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="row mt-55">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="progress pink">
                                                                ...
                                                                <div class="progress-bar"
                                                                     style="width:30%; background:#ff1170;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="progress green">
                                                                ...
                                                                <div class="progress-bar"
                                                                     style="width:0%; background:#21da9a;">
                                                            ...
                                                            <div class="progress pink">
                                                                <h3 class="progress-title">------</h3>
                                                                <div class="progress-bar"
                                                                     style="width:0%; background:#ff1170;">
                                                                    <div class="progress-value">0%</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-55">
                                                        <div class="col-md-6">
                                                            <div class="progress green">
                                                                ...
                                                                <div class="progress-bar"
                                                                     style="width:95%; background:#21da9a;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="vertical-tab" role="tabpanel">
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#gl-Section1" aria-controls="home"
                                                                      role="tab" data-toggle="tab">html template</a>
                            </li>
                            <li role="presentation"><a href="#gl-Section2" aria-controls="profile" role="tab"
                                                       data-toggle="tab">wev development</a></li>
                            <li role="presentation"><a href="#gl-Section3" aria-controls="messages" role="tab"
                                                       data-toggle="tab">word press</a></li>
                            <li role="presentation"><a href="#gl-Section4" aria-controls="messages" role="tab"
                                                       data-toggle="tab">landing page</a></li>
                            <li role="presentation"><a href="#gl-Section5" aria-controls="messages" role="tab"
                                                       data-toggle="tab">other works</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content tabs">
                                ...
                                <div class="row">
                                        ...
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/wordpress/wp2.png"><img
                                                        src="{{asset('client')}}/images/portfolio/wordpress/wp2.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/wordpress/wp1.jpg"> <img
                                                        src="{{asset('client')}}/images/portfolio/wordpress/wp1.1.jpg"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/landing1.png"> <img
                                                        src="{{asset('client')}}/images/portfolio/landing1.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/design/tem4.png"> <img
                                                        src="{{asset('client')}}/images/portfolio/design/tem4.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                            <a href="#" class="link">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/design/tem5.png"> <img
                                                        src="{{asset('client')}}/images/portfolio/design/tem5.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/design/tem6.png"> <img
                                                        src="{{asset('client')}}/images/portfolio/design/tem6.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4  col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/webdev/dev1.png"> <img
                                                        src="{{asset('client')}}/images/portfolio/webdev/dev1.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                            <a href="#" class="link">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images/portfolio/webdev/dev2.png"> <img
                                                        src="{{asset('client')}}/images/portfolio/webdev/dev2.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                            <a href="#" class="link">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4 gellery-bg">
                                        <div class="pricing-box clrbg-before clrbg-after transition"
                                            ...
                                            <div class="item">
                                                <a class="venobox" data-gall="myGallery"
                                                   href="images//portfolio/webdev/dev3.png"> <img
                                                        src="{{asset('client')}}/images/portfolio/webdev/dev3.1.png"
                                                        height="300" style="width: 100%" alt=""/>
                                                </a>
                                            </div>
                                            <a href="#" class="link">
                ...
                <div class="col-md-12">
                    <div id="testimonial-slider" class="owl-carousel">
                        ...
                        <div class="testimonial">
                            ...
                            <p class="description">“I think the main thing that distinguishes Website Design by rupom
                                ehsan is how seriously they take their work.”</p>
                            <div class="testimonial-content">
                                <div class="testimonial-profile">
                        ...
                        <div class="testimonial">
                            ...
                            <p class="description">I appreciate RUPOM EHSAN timeliness and communication. I was slow in
                                my response to his edits and he was very patient.</p>
                            <div class="testimonial-content">
                                <div class="testimonial-profile">
                            ...
                            <div class="serviceBox">
                                ...
                                <div class="blog-bottom">
                                    <div class="left col-md-6 col-sm-6">
                                        <button type="btn"><a href="{{url('/single-blog',$blog->id)}}">ReadMore</a>
                                        </button>
                                    ...
                                    <div class="blog-social">
                                        <div class="center">
                                            ...
                                            <div id="social-test">
                                                <ul class="social">
                                                    <li><a href="https://www.facebook.com/profile.php" title=""><i
                                                                class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                                    <li><a href="https://twitter.com" title=""><i class="fa fa-twitter"
                                                                                                  aria-hidden="true"></i>
                                                    </li>
    ...
    <section class="contact contact-bg" id="contact">
        <div class="container">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 contact-left" style="padding: 0px 39px; margin-top: 15%;left: 10%;">
                ...
                <p style="font-size: 15px;text-transform: capitalize;">"if you are like my service you can contact with
                    me or send me your valuable opinion here </p>
                    ...
                    <div class="wrap-contact100">
                        ...
                        <form id="contactForm" class="contact100-form">
                            ...
                            <div class="wrap-input100 validate-input mt-20"
                                ...
                                <input id="email" class="input100" id="email" type="email" name="email"
                                       placeholder="Enter your email">
                                <span class="focus-input100"></span>
                            </div>
                            <div class="wrap-input100 mt-20">
                                <input id="phone" class="input100" type="number" id="phone" name="phone"
