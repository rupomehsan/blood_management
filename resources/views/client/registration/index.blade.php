    ...
    <div class="register pb-20">
        <div class="row">
            ...
            <div class="col-md-3 register-left">
                <div class="hide-btn">
                    <button type="btn"><a href="{{route('website.alldoner')}}"
                                          style="color: white;border:1px solid white;padding:10px;background: rgba(0, 0, 0, 0.6);">SEE
                            ALL BLOOD DONOR</a></button>

                </div>
                <img src="{{asset('client')}}/images/blood.png" alt=""/>
                <h3>Welcome To Donating Blood</h3><br/>
                <h6 style="padding: 0px 10px;">“If you’re a blood donor, you’re a hero to someone, somewhere, who
                    received your gracious gift of life.”</h6><br/>
                <button type="btn"><a href="{{route('website.alldoner')}}"
                                      style="color: white;border:1px solid white;padding:10px;background: rgba(0, 0, 0, 0.6);">SEE
                        ALL BLOOD DONOR</a></button>
            </div>
            ...
            <div class="col-md-9 register-right">
                ...
                <h5 class="register-heading">[ "<span style="color:red;font-size: 30px;margin-top: 20px;"> * </span> "
                    Field is must be required !!! ]</h5>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="social_link" name="social"
                                       placeholder="Soicial Link" value=""/>
                            </div>

                            <div class="form-group">
                                <h5 style="padding-bottom: 10px;">Phone : <span style="color:red;">*</span></h5>
                                <input type="number" minlength="11" id="phone" maxlength="11" name="phone"
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        if (err.responseJSON.errors) {
                            ...
                            if (error.gender) {
                                $('#gender').after('<div class="alert alert-danger error">Gender  is required</div>')
                            }
